      ...
      <div class="page-main">
        ...
        <div class="my-3 my-md-5">
          <div class="container">
            <div class="row">              
            <div class="col-lg-12">
              <form class="card" action="actions/novoProduto.php" method="POST">
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6 col-md-4">
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="barcode" placeholder="78978978978978">
                      </div>
                    </div>
                    <div class="col-sm-6 col-md-4">
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control text-right" name="unitaryValue" aria-label="Valor">                         
                        </div>
                      </div>
                    </div>                    
                  </div>
